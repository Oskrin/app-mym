<?php
  ...
  function correo($correo, $destinatario, $mensaje) {  
    ...
    $mail->Username = "oskr.trov@gmail.com";  // SMTP username
    $mail->Password = 'oskrin1991'; // SMTP password
    $mail->SMTPSecure = 'tls';          
    $mail->Port = 587;      
    $mail->FromName = "WINCHAS EL VENEZOLANO";
    $mail->AddAddress($correo, $nombre);
    $mail->AddReplyTo("info@factservice.org", "Información");
    ...
    $mail->Subject = "Mensaje Contactos"; 
    $mail->Body = '
        <!doctype html>
