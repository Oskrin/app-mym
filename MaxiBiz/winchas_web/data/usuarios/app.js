	...
	jQuery(function($) {
		...
		$('#form_usuarios').validate({
			...
			messages: {
				...
				select_perfil: {
					required: "Por favor, Especifique un Perfil",
				},
			},
		...
		// llenar combo perfil
		function llenar_select_perfil() {
			$.ajax({
				url: 'data/usuarios/app.php',
				type: 'post',
				data: {llenar_perfil:'llenar_perfil'},
				success: function(data) {
					$('#select_perfil').html(data);
				}
			});
		}
		// fin
		...
		jQuery(function($) {
		    ...
		    jQuery(grid_selector).jqGrid({	        
		        ...
		        colNames: ['ID','IDENTIFICACIÓN','NOMBRES COMPLETOS','TELÉFONO','CELULAR','CIUDAD','DIRECCIÓN','CORREO','USUARIO','CLAVE','ID_PERFIL','PERFIL','FOTO','OBSERVACIONES'],
		        colModel:[      
		            ...
		            {name:'id_perfil',index:'id_perfil',frozen : true, hidden: true, align:'left',search:false,width:''},
		            {name:'perfil',index:'perfil',frozen : true, hidden: false, align:'left',search:false,width:''},
		        ...
		        ondblClickRow: function(rowid) {     	            	            
	            	...
	            	$("#logo").attr("src", "data/usuarios/fotos/"+ ret.foto);
	            	...
	            	$("#select_perfil").select2('val', ret.id_perfil).trigger("change");
